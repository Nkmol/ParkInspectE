...
USING (values 
	...
	(4, '2016-11-28', '2016-12-15 14:15:00', 'Halted', 'Payment not received yet'),
	(5, '2016-11-14', '2016-12-01 10:00:00', 'Finished', 'Owner was satisfied')

) AS Source ([client_id], [date], [deadline], [state], [clarification])  
ON Target.[client_id] = Source.[client_id] 
WHEN NOT MATCHED BY TARGET THEN  
 INSERT ([client_id], [date], [deadline], [state], [clarification])  
 VALUES ([client_id], [date], [deadline], [state], [clarification])  
WHEN MATCHED THEN
 UPDATE SET
