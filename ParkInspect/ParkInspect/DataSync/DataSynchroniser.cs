...
namespace ParkInspect.DataSync
{
    class DataSynchroniser
    {
        ...
        public DataSynchroniser()
        {
            ...
            local = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename='P:\Avans\Blok 6\PROJECT\ParkInspectE\ParkInspect\ParkInspect\LocalDatabase.mdf';Integrated Security=True");
            central = new SqlConnection(@"Data Source=BOB-DEKSTOP\SQLEXPRESS;Initial Catalog=parkInspect;Integrated Security=True");
